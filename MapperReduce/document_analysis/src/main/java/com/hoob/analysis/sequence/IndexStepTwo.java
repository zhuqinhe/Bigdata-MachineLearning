...
public class IndexStepTwo {
	...
	public static void main(String[] args) throws Exception{
		...
		FileInputFormat.setInputPaths(job, new Path("D:/gitprogect/data/output/files-sequence"));
		FileOutputFormat.setOutputPath(job, new Path("D:/gitprogect/data/output/files-sequence-new"));
