...
public class IndexStepOne {
	...
	public static void main(String[] args) throws Exception{
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\ProgramFiles\\BigData\\data\\input\\files"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\ProgramFiles\\BigData\\data\\out\\files-sequence"));
