...
public class IndexStepTwo {
	...
	public static void main(String[] args) throws Exception{
		...
		FileInputFormat.setInputPaths(job, new Path("D:\\ProgramFiles\\BigData\\data\\output\\files"));
		FileOutputFormat.setOutputPath(job, new Path("D:\\ProgramFiles\\BigData\\data\\output\\filessteptwo"));
