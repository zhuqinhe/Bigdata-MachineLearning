...
public class KMeansModelApp {
    public static void main(String[] args) throws IOException {
        ...
        //        load("D:\\ProgramFiles\\GitData\\hadoop\\spark\\SparkTest\\src\\main\\data\\mllib\\input\\mllibFromSpark\\kmeans_data.txt");
       ...
       // JavaRDD<Row>dRdd=stringRdd.map(line->{
        //    String[] ss=line.split(" ");
        //    return   RowFactory.create(Vectors.dense(Double.parseDouble(ss[0]), Double.parseDouble(ss[1]),Double.parseDouble(ss[2])));
        //});
