package cn.hoob.machine_learning.regressor.RandomForestRegressor;
...
/**
 ...
 对新实例进行预测时，随机森林需要整合其各个决策树的预测结果。回归和分类问题的整合的方式略有不同。
 ...
 **/
public class RandomForestRegressionModelApp {
