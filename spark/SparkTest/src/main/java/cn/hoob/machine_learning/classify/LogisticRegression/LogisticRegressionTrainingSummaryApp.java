...
/**
 spark.ml逻辑回归工具同样支持提取模总结。LogisticRegressionTrainingSummary提供LogisticRegressionModel的总结。
 目前仅支持二分类问题，所以总结必须明确投掷到BinaryLogisticRegressionTrainingSummary。支持多分类问题后可能有所改善
 **/
public class LogisticRegressionTrainingSummaryApp {
