 ...
 * a1.sources.r1.spoolDir = /root/apps/testdata/flume_log/flume-poll-spark
 ...
 *
 * a1.sinks.k1.hostname=hdp1
 * a1.sinks.k1.port = 10000
 * a1.sinks.k1.batchSize= 2000
 *
 *
 */
public class SparkStreamingFlumePoll {
    public static void main(String[] args) throws Exception {
        ...
        JavaStreamingContext jsc = new JavaStreamingContext(conf, Durations.seconds(20));
         //Poll 模式，flume Poll
        JavaReceiverInputDStream<SparkFlumeEvent> pollingStream = FlumeUtils.createPollingStream(jsc, "hdp1", 10000);
