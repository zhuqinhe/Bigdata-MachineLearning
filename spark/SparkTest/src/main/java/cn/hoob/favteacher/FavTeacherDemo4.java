 ...
 * 分析每个学科最受欢迎的老师的课
 */
public class FavTeacherDemo4 {
    public static void main(String[] args) {

        SparkConf conf = new SparkConf().setAppName("FavTeacherDemo4").setMaster("local");
        //创建sparkContext
        ...
        //reduce后的rdd重新定义其分区
        JavaPairRDD<Tuple2<String,String>, Integer> partionRdd=reducedRdd.partitionBy(sp);
        //假设topN=2
        int topN=2;
        JavaRDD<Tuple2<Tuple2<String,String>, Integer>>onePartionRdd=partionRdd.mapPartitions(it->{
