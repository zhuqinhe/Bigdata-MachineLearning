...
public class OrderTopn {
	...
	public static void main(String[] args) throws Exception {
		...
		//conf.addResource("topn.xml");添加配置文件
		conf.setInt("top.n", 2);
		...
		FileInputFormat.setInputPaths(job, new Path("D:/gitprogect/data/input/order"));
		FileOutputFormat.setOutputPath(job, new Path("D:/gitprogect/data/output/order"));
